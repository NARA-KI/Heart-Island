// ============================================
// 心岛计划 — 选项评分与结果一致性审计脚本
// Usage: node scripts/option-alignment-audit.mjs
// ============================================
...
// ============================================
// EMBEDDED DATA (B+ calibration, current live config)
// ============================================

const DIM_ORDER = ['CL','AU','SE','EX','RP','IN','ID','ST','CA','NV','ME','EV'];
...
// All 36 scenes with 144 options (from scoring.mjs — identical to app.js)
const scenes = [
  // ===== 靠近海岸 (CL) — scenes 1-3 =====
...
// B+ calibration personality data (current live config from app.js)
const personalities = [
  { id:'lighthouse', name:'灯塔型', targetVector:{CL:65,AU:45,SE:45,EX:70,RP:85,IN:78,ID:45,ST:78,CA:92,NV:30,ME:45,EV:45}, coreThresholds:{CA:80,RP:75,IN:65}, hitLine:'你总在照亮别人，却经常忘记自己也需要被照亮。', keywords:['守护','可靠','付出'], keyDimensions:["CA","RP","IN","ST","EX","CL"] },
  { id:'gatekeeper', name:'守门人型', targetVector:{CL:45,AU:84,SE:42,EX:35,RP:65,IN:30,ID:45,ST:84,CA:48,NV:25,ME:42,EV:45}, coreThresholds:{AU:78,ST:68,EX_MAX:42}, hitLine:'进入你的世界很难，但离开更难。', keywords:['谨慎','忠诚','边界'], keyDimensions:["AU","ST","EX","IN","RP","SE"] },
  { id:'nest_builder', name:'筑巢型', targetVector:{CL:88,AU:30,SE:68,EX:65,RP:75,IN:55,ID:45,ST:92,CA:70,NV:22,ME:55,EV:45}, coreThresholds:{CL:80,ST:80,AU_MAX:45}, hitLine:'你想经营关系，而不是体验关系。', keywords:['稳定','经营','陪伴'], keyDimensions:["CL","ST","AU","CA","RP","SE"] },
  { id:'old_captain', name:'旧船长型', targetVector:{CL:75,AU:42,SE:72,EX:48,RP:45,IN:38,ID:55,ST:82,CA:55,NV:15,ME:95,EV:62}, coreThresholds:{ME:80,ST:70,NV_MAX:35}, hitLine:'你记住的从来不是过去，而是过去里的自己。', keywords:['念旧','深情','珍藏'], keyDimensions:["ME","ST","NV","SE","CL","EV"] },
  { id:'migratory_bird', name:'候鸟型', targetVector:{CL:60,AU:84,SE:50,EX:52,RP:35,IN:65,ID:58,ST:28,NV:84,CA:35,ME:55,EV:72}, coreThresholds:{AU:72,NV:68,ST_MAX:42}, hitLine:'你向往亲密，却害怕亲密吞掉你的自由。', keywords:['自由','矛盾','敏感'], keyDimensions:["AU","NV","ST","CL","EV","RP"] },
  { id:'island', name:'岛屿型', targetVector:{CL:28,AU:94,SE:25,EX:25,RP:50,IN:28,ID:30,ST:45,CA:22,NV:35,ME:25,EV:25}, coreThresholds:{AU:85,CL_MAX:40,EX_MAX:35}, hitLine:'你不是不需要爱，只是习惯一个人解决问题。', keywords:['独立','自足','安静'], keyDimensions:["AU","CL","EX","SE","CA","IN"] },
  { id:'explorer', name:'探险家型', targetVector:{CL:55,AU:78,SE:35,EX:68,RP:50,IN:84,ID:60,ST:22,NV:95,CA:30,ME:25,EV:45}, coreThresholds:{NV:90,IN:75,ST_MAX:40}, hitLine:'你爱上的往往不是一个人，而是一种新的可能。', keywords:['好奇','探索','自由'], keyDimensions:["NV","IN","ST","AU","EX","ID"] },
  { id:'wandering_poet', name:'流浪诗人型', targetVector:{CL:60,AU:70,SE:45,EX:65,RP:48,IN:55,ID:95,ST:30,NV:78,CA:38,ME:62,EV:65}, coreThresholds:{ID:85,NV:65,ST_MAX:45}, hitLine:'你寻找的不是爱情，而是灵魂共鸣。', keywords:['浪漫','理想','诗意'], keyDimensions:["ID","NV","ST","EX","ME","AU"] },
  { id:'collector', name:'收藏家型', targetVector:{CL:58,AU:62,SE:60,EX:32,RP:38,IN:25,ID:78,ST:52,CA:35,NV:25,ME:95,EV:70}, coreThresholds:{ME:85,IN_MAX:40,EX_MAX:45}, hitLine:'你爱的不是拥有，而是那些被珍藏的瞬间。', keywords:['细腻','珍藏','含蓄'], keyDimensions:["ME","IN","EX","ID","EV","AU"] },
  { id:'script_writer', name:'剧本型', targetVector:{CL:65,AU:45,SE:72,EX:55,RP:40,IN:50,ID:92,ST:55,CA:38,NV:55,ME:70,EV:78}, coreThresholds:{ID:85,SE:65,EV:65}, hitLine:'故事还没开始，你已经在心里演完了结局。', keywords:['想象','浪漫','期待'], keyDimensions:["ID","SE","EV","ME","CL","RP"] },
  { id:'spark', name:'星火型', targetVector:{CL:78,AU:42,SE:62,EX:85,RP:35,IN:90,ID:75,ST:35,NV:82,CA:35,ME:30,EV:75}, coreThresholds:{IN:80,EX:75,NV:70}, hitLine:'你点燃一段关系的速度，往往比别人更快。', keywords:['热烈','冲动','真挚'], keyDimensions:["IN","EX","NV","ID","EV","ST"] },
  { id:'moonlight', name:'月光型', targetVector:{CL:78,AU:38,SE:60,EX:70,RP:65,IN:45,ID:82,ST:70,CA:62,NV:35,ME:55,EV:72}, coreThresholds:{ID:78,CA:58,EV:62}, hitLine:'你总能看见别人身上的光。', keywords:['温柔','包容','欣赏'], keyDimensions:["ID","CA","EV","CL","EX","ST"] },
  { id:'mirror', name:'镜像型', targetVector:{CL:72,AU:35,SE:70,EX:58,RP:48,IN:38,ID:62,ST:60,CA:70,NV:25,ME:50,EV:92}, coreThresholds:{EV:82,CA:58,AU_MAX:48}, hitLine:'别人的情绪，常常比你的情绪更早影响你。', keywords:['共情','敏感','体贴'], keyDimensions:["EV","CA","AU","SE","CL","IN"] },
  { id:'resonance', name:'共振型', targetVector:{CL:72,AU:55,SE:45,EX:80,RP:70,IN:50,ID:88,ST:62,CA:45,NV:45,ME:50,EV:55}, coreThresholds:{ID:80,EX:70,RP:60}, hitLine:'你想要的不是陪伴，而是理解。', keywords:['深度','理解','共鸣'], keyDimensions:["ID","EX","RP","CL","ST","SE"] },
  { id:'tide', name:'潮汐型', targetVector:{CL:75,AU:68,SE:82,EX:65,RP:25,IN:45,ID:70,ST:35,NV:60,CA:35,ME:70,EV:95}, coreThresholds:{EV:85,RP_MAX:40,SE:70}, hitLine:'靠近是真的，离开也是真的。', keywords:['矛盾','浓烈','拉扯'], keyDimensions:["EV","RP","SE","CL","AU","ST"] },
  { id:'greenhouse', name:'温室型', targetVector:{CL:82,AU:28,SE:88,EX:68,RP:45,IN:35,ID:65,ST:82,CA:55,NV:18,ME:55,EV:85}, coreThresholds:{SE:75,CL:70,AU_MAX:48}, hitLine:'当被好好爱的时候，你会长出最真实的自己。', keywords:['依赖','投入','敏感'], keyDimensions:["SE","CL","AU","EV","ST","IN"] },
  { id:'deep_sea', name:'深海型', targetVector:{CL:60,AU:72,SE:58,EX:25,RP:55,IN:22,ID:75,ST:70,CA:45,NV:25,ME:65,EV:82}, coreThresholds:{EV:65,EX_MAX:45,ID:65}, hitLine:'你表面平静，但很少有人知道你内心到底有多深。', keywords:['深邃','内敛','丰富'], keyDimensions:["EV","EX","ID","AU","ST","IN"] },
  { id:'aurora', name:'极光型', targetVector:{CL:60,AU:82,SE:40,EX:82,RP:45,IN:82,ID:82,ST:25,NV:88,CA:30,ME:35,EV:65}, coreThresholds:{NV:75,ID:70,IN:65,ST_MAX:38}, hitLine:'你的人生轨迹从来不喜欢按照常规路线运行。', keywords:['独特','变幻','自由'], keyDimensions:["NV","ID","IN","AU","EX","ST"] },
  { id:'black_forest', name:'黑森林型', targetVector:{CL:42,AU:88,SE:62,EX:18,RP:40,IN:22,ID:65,ST:55,CA:35,NV:32,ME:55,EV:78}, coreThresholds:{AU:80,EX_MAX:30,EV:65}, hitLine:'你让人想靠近，却又让人不知道该如何靠近。', keywords:['神秘','防御','独立'], keyDimensions:["AU","EX","EV","CL","SE","IN"] },
  { id:'stargazer', name:'观星者型', targetVector:{CL:52,AU:70,SE:42,EX:45,RP:62,IN:35,ID:92,ST:82,CA:45,NV:35,ME:40,EV:45}, coreThresholds:{ID:85,ST:75,IN_MAX:45}, hitLine:'你总在看未来，所以经常忘记活在当下。', keywords:['远见','理性','规划'], keyDimensions:["ID","ST","IN","AU","RP","CL"] }
];

// Beta 0.9.8: Core / Branch classification
const CORE_TYPE_IDS = [
  'lighthouse','gatekeeper','nest_builder','collector','migratory_bird',
  'island','explorer','wandering_poet','spark','moonlight','mirror','stargazer'
];
const BRANCH_TYPE_IDS = [
  'old_captain','script_writer','resonance','tide',
  'greenhouse','deep_sea','aurora','black_forest'
];

// ============================================
// SCORING FUNCTIONS (B+ calibration)
// ============================================
function getScore(obj, key, fallback = 50) {
  const value = obj?.[key];
  return Number.isFinite(value) ? value : fallback;
}

function computeDimensionScores(choiceHistory) {
  const groups = {};
...
function matchAllTypes(avgDimensionScores) {
  const results = [];
  for (const p of personalities) {
    ...
    for (const dim of DIM_ORDER) {
      ...
      for (const key of Object.keys(thresholds)) {
        ...
        if (baseDim === dim) { weight = 2.20; break; }
      }
    ...
    for (const [key, threshold] of Object.entries(thresholds)) {
      if (key.endsWith('_MAX')) {
        ...
        if (getScore(avgDimensionScores, dim) <= threshold) metCount++; else failCount++;
      } else {
        if (getScore(avgDimensionScores, key) >= threshold) metCount++; else failCount++;
      }
    }
...
// ============================================
// A. DIMENSION PATH CONSISTENCY TESTS
// ============================================
console.log('═══════════════════════════════════');
console.log('🧪 选项评分一致性审计');
console.log('═══════════════════════════════════');
console.log('\n📐 A. 维度路径一致性测试');

const dimensionPathResults = {};
const dimScenes = {};
scenes.forEach(s => {
  if (!dimScenes[s.dimension]) dimScenes[s.dimension] = [];
  dimScenes[s.dimension].push(s);
});

for (const dim of DIM_ORDER) {
  const threeScenes = dimScenes[dim];
  const pathResults = {};

  // Path 1: All semantic HIGH (find highest-scored option per scene)
  const highPath = threeScenes.map(s => {
    const best = s.options.reduce((a,b) => a.score >= b.score ? a : b);
    return { sceneId: s.id, dimension: s.dimension, optionId: best.id, score: best.score, text: best.text };
  });
  const highScores = computeDimensionScores(highPath);
  pathResults.high = { dimScore: highScores[dim], allScores: highPath.map(h => h.score), ok: highScores[dim] >= 85 };

  // Path 2: All semantic LOW (find lowest-scored option per scene)
  const lowPath = threeScenes.map(s => {
    const worst = s.options.reduce((a,b) => a.score <= b.score ? a : b);
    return { sceneId: s.id, dimension: s.dimension, optionId: worst.id, score: worst.score, text: worst.text };
  });
  const lowScores = computeDimensionScores(lowPath);
  pathResults.low = { dimScore: lowScores[dim], allScores: lowPath.map(l => l.score), ok: lowScores[dim] <= 15 };

  // Path 3: All mid (mix of 67 and 33)
  const midPath = threeScenes.map((s,i) => {
    const idx = i % 2 === 0 ? 1 : 2; // alternate B(67) and C(33)
    return { sceneId: s.id, dimension: s.dimension, optionId: s.options[idx].id, score: s.options[idx].score, text: s.options[idx].text };
  });
  const midScores = computeDimensionScores(midPath);
  pathResults.mid = { dimScore: midScores[dim], allScores: midPath.map(m => m.score), ok: midScores[dim] >= 30 && midScores[dim] <= 70 };

  // Path 4: Mixed
  const mixedPath = threeScenes.map((s,i) => {
    const idx = [0,3,1][i]; // high, low, mid
    return { sceneId: s.id, dimension: s.dimension, optionId: s.options[idx].id, score: s.options[idx].score, text: s.options[idx].text };
  });
  const mixedScores = computeDimensionScores(mixedPath);
  pathResults.mixed = { dimScore: mixedScores[dim], allScores: mixedPath.map(m => m.score), ok: true };

  const allOk = pathResults.high.ok && pathResults.low.ok && pathResults.mid.ok;
  if (!pathResults.high.ok) console.log(`   ⚠️ ${dim} 高路径: 得分=${pathResults.high.dimScore} (期望≥85)`);
  if (!pathResults.low.ok) console.log(`   ⚠️ ${dim} 低路径: 得分=${pathResults.low.dimScore} (期望≤15)`);
  if (!pathResults.mid.ok) console.log(`   ⚠️ ${dim} 中路径: 得分=${pathResults.mid.dimScore} (期望30-70)`);

  dimensionPathResults[dim] = { ...pathResults, allOk };
}

const dimPathPass = Object.values(dimensionPathResults).filter(r => r.allOk).length;
console.log(`   ✅ ${dimPathPass}/12 维度路径通过`);
...
for (const p of personalities) {
  ...
  for (const scene of scenes) {
    ...
    let bestOpt = scene.options[0];
    let bestDiff = Math.abs(bestOpt.score - targetScore);
    for (const opt of scene.options) {
      const d = Math.abs(opt.score - targetScore);
      if (d < bestDiff) { bestDiff = d; bestOpt = opt; }
    }
    history.push({ sceneId: scene.id, dimension: dim, optionId: bestOpt.id, score: bestOpt.score });
  }
  ...
  const selfRank = results.findIndex(r => r.personality.id === p.id) + 1;
  const selfScore = results.find(r => r.personality.id === p.id).matchScore;
  const hit = primary.personality.id === p.id;
  const gap = primary.matchScore - secondary.matchScore;

  // Track dimension score gaps from target
  const dimGaps = {};
  for (const dim of DIM_ORDER) {
    const actual = getScore(avgs, dim);
    const target = getScore(p.targetVector, dim);
    const g = Math.abs(actual - target);
    if (g > 25) dimGaps[dim] = { actual, target, gap: g };
  }

  if (!hit) {
    console.log(`   ❌ ${p.name}: 黄金路径失败 → #1=${primary.personality.name}(${primary.matchScore}) 自己排#${selfRank}(${selfScore})`);
  }

  goldenPathResults.push({
    type: p.name, typeId: p.id, hit, actualPrimary: primary.personality.name,
    actualSecondary: secondary.personality.name, selfRank, selfScore, gap,
    primaryScore: primary.matchScore, secondaryScore: secondary.matchScore,
    dimGaps, issueCount: Object.keys(dimGaps).length
  });
}

const goldenPass = goldenPathResults.filter(r => r.hit).length;
const coreGoldenPaths = goldenPathResults.filter(r => CORE_TYPE_IDS.includes(r.typeId));
const branchGoldenPaths = goldenPathResults.filter(r => BRANCH_TYPE_IDS.includes(r.typeId));
const coreGoldenPass = coreGoldenPaths.filter(r => r.hit).length;
const branchGoldenPass = branchGoldenPaths.filter(r => r.hit).length;
console.log(`   ✅ ${goldenPass}/20 黄金路径命中 (核心:${coreGoldenPass}/12, 分支:${branchGoldenPass}/8)`);

// ============================================
// C. REVERSE SEMANTIC TESTS
// ============================================
console.log('\n📐 C. 反向语义测试');

const reverseResults = [];
for (const p of personalities) {
  const keyDims = p.keyDimensions;
  const history = [];

  for (const scene of scenes) {
    const dim = scene.dimension;
    if (keyDims.includes(dim)) {
      // Choose OPPOSITE of key dimension tendency
      const targetScore = getScore(p.targetVector, dim);
      // If target is high (>60), pick low option; if low (<40), pick high option
      if (targetScore >= 60) {
        history.push({ sceneId: scene.id, dimension: dim, optionId: scene.options[3].id, score: scene.options[3].score });
      } else {
        history.push({ sceneId: scene.id, dimension: dim, optionId: scene.options[0].id, score: scene.options[0].score });
      }
    } else {
      // Other dimensions: pick middle
      history.push({ sceneId: scene.id, dimension: dim, optionId: scene.options[1].id, score: scene.options[1].score });
    }
  }
  ...
  const results = matchAllTypes(avgs);
  const primary = results[0];
  const stillHit = primary.personality.id === p.id;
  const selfRank = results.findIndex(r => r.personality.id === p.id) + 1;

  if (stillHit) {
    console.log(`   ⚠️ ${p.name}: 反向路径仍命中! (${primary.matchScore}分)`);
  }

  reverseResults.push({
    type: p.name, typeId: p.id, stillHit,
    actualPrimary: primary.personality.name,
    selfRank, selfScore: results.find(r=>r.personality.id===p.id)?.matchScore || 0,
    risk: stillHit ? 'high' : (selfRank <= 5 ? 'medium' : 'low')
  });
}

const reversePass = reverseResults.filter(r => !r.stillHit).length;
console.log(`   ✅ ${reversePass}/20 反向路径正确排除`);

// ============================================
// D. RESULT PAGE TEXT CONSISTENCY
// ============================================
console.log('\n📐 D. 结果页文案一致性检查');

// Check each personality's targetVector against traits that imply high/low dimensions
const textConsistencyResults = [];

// Dimension-to-trait keywords mapping (what result text typically claims)
const dimClaimPatterns = {
  CL: { high: ['陪伴','靠近','共享','亲密','连接','温暖','黏','一起','日常'], low: ['距离','独立空间','不需要陪伴','疏离'] },
  AU: { high: ['自由','空间','边界','独立','自主','独行','节奏','一个人'], low: ['依赖','融合','没有边界','离不开'] },
  SE: { high: ['回应','确认','承诺','安全','稳定信号','被肯定','被需要'], low: ['不依赖确认','不需要回应','不依赖外部'] },
  EX: { high: ['表达','说出','真实','脆弱','开放','坦率','沟通'], low: ['藏起来','不说','沉默','不表达','内敛','克制'] },
  RP: { high: ['修复','沟通','解决','重建','恢复','弥补','重新连接'], low: ['逃避','冷战','不处理','放弃','断裂'] },
  IN: { high: ['主动','推进','靠近','追求','规划下一步','行动','热烈'], low: ['被动','等待','观察','慢热','不主动'] },
  ID: { high: ['灵魂','命运','共鸣','浪漫','想象','理想','诗意','精神'], low: ['现实','务实','脚踏实地','不浪漫','实际'] },
  ST: { high: ['长期','稳定','经营','承诺','建设','未来','规划','长久'], low: ['短暂','变化','不确定','不固定','开放'] },
  CA: { high: ['照顾','承担','支撑','托底','付出','守护','可靠','帮助'], low: ['不承担','自顾自','不照顾','独立负责'] },
  NV: { high: ['新鲜','变化','探索','未知','冒险','刺激','新奇'], low: ['稳定','重复','熟悉','不变','安全','一致'] },
  ME: { high: ['念旧','怀念','回忆','珍藏','过去','记得','不忘'], low: ['向前看','放下','不回头','不念旧','未来'] },
  EV: { high: ['敏感','情绪','氛围','感染','共情','感受','察觉'], low: ['理性','不受影响','冷静','不被牵动','稳定'] }
};

// Result page text fragments per personality (from app.js coreTraits, portrait, etc.)
// We check if text claims about a dimension match the targetVector
for (const p of personalities) {
  const conflicts = [];

  for (const dim of DIM_ORDER) {
    const tv = getScore(p.targetVector, dim);

    // Check if targetVector is HIGH (>65) but text suggests low
    // or targetVector is LOW (<35) but text suggests high
    // These would be structural conflicts

    // We check the hitLine, keywords, and keyDimensions for implicit claims
    // More detailed text checks done in manual analysis
  }

  // Specific checks per type based on known text claims vs targetVector
  const checks = [];

  // Lighthouse: CA=92, RP=85, IN=78 — high "照顾" claims match high CA
  if (p.id === 'lighthouse') {
    if (p.targetVector.CA < 70) checks.push('hitLine说"照亮别人"但CA<70');
    if (p.targetVector.RP < 65) checks.push('强调"修复"但RP<65');
  }
  // Gatekeeper: AU=82, ST=78 — "很难进入" matches high AU
  if (p.id === 'gatekeeper') {
    if (p.targetVector.AU < 65) checks.push('强调"边界"但AU<65');
  }
  // Island: AU=94, CL=28 — "独立" matches high AU + low CL
  if (p.id === 'island') {
    if (p.targetVector.AU < 70) checks.push('强调"独立"但AU<70');
    if (p.targetVector.CL > 45) checks.push('强调"不需要陪伴"但CL>45');
  }
  // Explorer: NV=95, IN=84 — "新鲜/探索" matches high NV
  if (p.id === 'explorer') {
    if (p.targetVector.NV < 75) checks.push('强调"探索新鲜"但NV<75');
  }
  // Wandering poet: ID=95 — "灵魂共鸣" matches high ID
  if (p.id === 'wandering_poet') {
    if (p.targetVector.ID < 75) checks.push('强调"灵魂共鸣"但ID<75');
  }
  // Collector: ME=95 — "珍藏" matches high ME
  if (p.id === 'collector') {
    if (p.targetVector.ME < 75) checks.push('强调"珍藏回忆"但ME<75');
  }
  // Mirror: EV=92, CA=70 — "情绪敏感/共情" matches high EV+CA
  if (p.id === 'mirror') {
    if (p.targetVector.EV < 75) checks.push('强调"情绪吸收"但EV<75');
  }
  // Greenhouse: SE=88, CL=82 — "需要安全感" matches high SE+CL
  if (p.id === 'greenhouse') {
    if (p.targetVector.SE < 70) checks.push('强调"需要安全感"但SE<70');
    if (p.targetVector.CL < 65) checks.push('强调"渴望陪伴"但CL<65');
  }
  // Deep sea: EV=82, EX=25 — "表面平静/内心深" matches high EV + low EX
  if (p.id === 'deep_sea') {
    if (p.targetVector.EV < 65) checks.push('强调"情绪浓度高"但EV<65');
    if (p.targetVector.EX > 45) checks.push('强调"不表达"但EX>45');
  }
  // Aurora: NV=88, ID=82, IN=82 — "独特变幻" matches high NV+ID
  if (p.id === 'aurora') {
    if (p.targetVector.NV < 70) checks.push('强调"变幻自由"但NV<70');
  }
  // Black forest: AU=88, EX=18 — "神秘防御" matches high AU + low EX
  if (p.id === 'black_forest') {
    if (p.targetVector.AU < 70) checks.push('强调"防御/独立"但AU<70');
    if (p.targetVector.EX > 35) checks.push('强调"不表达"但EX>35');
  }
  // Stargazer: ID=92, ST=82 — "远见/规划" matches high ID+ST
  if (p.id === 'stargazer') {
    if (p.targetVector.ID < 75) checks.push('强调"理想主义"但ID<75');
  }

  // Default checks: if hitLine/keywords imply a dimension is high, verify targetVector
  // Using the dimClaimPatterns to do a basic text scan
  // (Full text scan would be better with actual coreTraits/portrait text)

  textConsistencyResults.push({
    type: p.name, typeId: p.id,
    conflicts: checks,
    pass: checks.length === 0
  });
}

const textPass = textConsistencyResults.filter(r => r.pass).length;
console.log(`   ✅ ${textPass}/20 文案一致性通过基本检查`);

// ============================================
// E. OPTION SEMANTICS SUMMARY (manual review framework)
// ============================================
// Generate data structure for all 144 options to facilitate manual review
const allOptions = [];
for (const scene of scenes) {
  for (const opt of scene.options) {
    allOptions.push({
      ...
      dimLabel: DIM_META[scene.dimension].label,
      dimDesc: DIM_META[scene.dimension].desc,
      optionId: opt.id,
      currentScore: opt.score,
      optionText: opt.text,
      memoryTag: opt.memoryTag
    });
  }
}
...
const output = {
  ...
  version: 'Beta 0.9 B+ calibration',
  totalScenes: 36,
  totalOptions: 144,
  dimensions: 12,
  personalityTypes: 20,
  ...
  dimensionPathTests: {
    passCount: dimPathPass,
    totalDimensions: 12,
    results: dimensionPathResults
  },

  goldenPathTests: {
    passCount: goldenPass,
    totalTypes: 20,
    corePassCount: coreGoldenPass,
    coreTotalTypes: 12,
    branchPassCount: branchGoldenPass,
    branchTotalTypes: 8,
    results: goldenPathResults
  },

  reversePathTests: {
    passCount: reversePass,
    totalTypes: 20,
    results: reverseResults
  },

  textConsistencyCheck: {
    passCount: textPass,
    totalTypes: 20,
    results: textConsistencyResults
  },

  optionData: allOptions
};

const jsonPath = path.join(REPORTS_DIR, 'option-result-alignment-audit.json');
fs.writeFileSync(jsonPath, JSON.stringify(output, null, 2), 'utf-8');

console.log('\n═══════════════════════════════════');
console.log('📊 审计数据已生成');
console.log(`   维度路径: ${dimPathPass}/12`);
console.log(`   黄金路径: ${goldenPass}/20 (核心:${coreGoldenPass}/12, 分支:${branchGoldenPass}/8)`);
console.log(`   反向测试: ${reversePass}/20`);
console.log(`   文案一致: ${textPass}/20`);
